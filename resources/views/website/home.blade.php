                                ...
                                @csrf
                                  <div class="row clearfix">
                                      <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                          <input type="text" name="name" placeholder="{{trans('website/appointment.Name')}}" required="">
                                          @if ($errors->has('name'))
                                      ...
                                      <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                          <input type="text" name="Section_id" placeholder="{{trans('website/appointment.Department')}}">
                                      ...
                                      <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                          <textarea name="messege" placeholder="{{trans('website/appointment.Message')}}"></textarea>
                                      </div>
